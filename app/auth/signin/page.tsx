    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-green-50 via-white to-blue-50 px-4">
      <div className="w-full max-w-sm">
        ...
        <div className="text-center mb-8">
          ...
          <h1 className="text-2xl font-extrabold text-navy-900 mt-4">Welcome back</h1>
          <p className="text-gray-500 text-sm mt-1">Sign in to save your scans and analysis history</p>
        </div>
        ...
        <p className="text-center text-sm text-gray-500 mt-6">
          ...
          <Link href="/scan" className="text-green-700 font-medium hover:underline">
            Scan as guest
          </Link>
        </p>
      </div>
